...
describe('map-sections', () => {
  ...
  it('should text section with invalid data', () => {
  ...
  it('should text section.section-grid with no text_grid or image_grid', () => {
    ...
    expect(withNoTextGrid.length).toBe(2);
  });
  ...
  it('should map section two columns data', () => {
    const data = mapSectionTwoColumns({
